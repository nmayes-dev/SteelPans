        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MidiFiles_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMidiFiles", x => new { x.GroupId, x.MidiFileId });
                    table.ForeignKey(
                        name: "FK_GroupMidiFiles_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMidiFiles_MidiFiles_MidiFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MidiFileId = table.Column<Guid>(type: "uuid", nullable: false),
                    TrackIndex = table.Column<int>(type: "integer", nullable: false),
                    TrackName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMidiFiles_MidiFileId",
                table: "GroupMidiFiles",
                column: "MidiFileId");
